        ...
        <div class="inner-footer">
            <ul>
                <li class="link">
                    ...
                    <a :href="footerLink.gitHub">{{ footerLink.gitHub }}</a>
                </li>
                <li class="link">
                    ...
                    <a :href="footerLink.gmail">{{ footerLink.gmail }}</a>
...
// const { startAnim } = useAnimatedCubes(overlay);
const footerLink = reactive(
    {
        gitHub: 'https://github.com/snyder2709',
        gmail: 'https://guygetting@gmail.com'
    }
)
